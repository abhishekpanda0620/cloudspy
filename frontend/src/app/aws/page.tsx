...
export default function AwsPage() {
  ...
  const mockResources: ResourceItem[] = [
    { id: "i-1234567890abcdef0", type: "EC2 Instance", region: "us-east-1", status: "running", cost: 45.20 },
    { id: "vol-0123456789abcdef0", type: "EBS Volume", region: "us-east-1", status: "in-use", cost: 12.50 },
    { id: "db-instance-1", type: "RDS Instance", region: "us-west-2", status: "available", cost: 89.30 },
    { id: "bucket-cloudspy-data", type: "S3 Bucket", region: "us-east-1", status: "active", cost: 5.75 },
  ];
      ...
      <div className="w-full max-w-7xl mx-auto space-y-6">
        ...
        <div className="flex items-center justify-between mb-8">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-3xl font-bold text-orange-700">AWS Cost Dashboard</h1>
              <p className="text-gray-600">Real-time visibility into your AWS cloud spend and resources</p>
            </div>
          </div>
        ...
        <Card className="p-6 bg-gradient-to-r from-orange-50 to-white border-l-4 border-l-orange-400">
          <div className="grid md:grid-cols-2 gap-6">
            <div>
              <label htmlFor="role-arn" className="block text-sm font-medium text-orange-700 mb-2">
                AWS Role ARN *
              </label>
              <input
                id="role-arn"
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          ...
          <Card className="p-6 bg-gradient-to-br from-blue-50 to-blue-100 border-blue-200">
            ...
            <div className="mt-2">
              <span className="text-xs text-blue-600">Across {awsRegions.length - 1} regions</span>
            </div>
          </Card>
          ...
          <Card className="p-6 bg-gradient-to-br from-green-50 to-green-100 border-green-200">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm text-green-600 font-medium">Top Service</p>
                <p className="text-2xl font-bold text-green-700">{topServices[0]?.service || 'N/A'}</p>
              </div>
              <span className="text-3xl">{getServiceIcon(topServices[0]?.service || '')}</span>
            </div>
            <div className="mt-2">
              <span className="text-xs text-green-600">${topServices[0]?.amount.toFixed(2) || '0.00'} this period</span>
            </div>
          </Card>
              ...
              <div className="grid md:grid-cols-3 gap-4">
                <div className="bg-orange-50 p-4 rounded-lg">
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <span className="font-medium text-orange-700">Cost Optimization</span>
                  </div>
                  <p className="text-sm text-gray-600">Consider rightsizing EC2 instances to save ~15% on compute costs</p>
                </div>
                <div className="bg-blue-50 p-4 rounded-lg">
                  ...
                  <p className="text-sm text-gray-600">S3 storage costs increased by 23% this month</p>
                </div>
                <div className="bg-green-50 p-4 rounded-lg">
                  ...
                  <p className="text-sm text-gray-600">Enable Reserved Instances for consistent workloads</p>
                </div>
              </div>
            </Card>
          </TabsContent>
            ...
            <Card className="p-6">
              ...
              {loading ? (
                <div className="flex items-center justify-center h-32">
                  <svg className="animate-spin h-8 w-8 text-orange-600 mr-3" viewBox="0 0 24 24">
                    <circle className="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="4" />
                    <path className="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8v8z" />
                  </svg>
                  <span className="text-gray-600">Loading AWS cost data...</span>
                </div>
              ) : data.length > 0 ? (
                    ...
                    <tbody>
                      {data.map((item, idx) => (
                        <tr key={idx} className="border-b hover:bg-orange-50 transition-colors">
                          ...
                          <td className="py-3 px-4 font-bold text-orange-700">${item.amount.toFixed(2)}</td>
                ...
                <div className="text-center py-12">
                  ...
                  <h3 className="text-lg font-medium text-gray-800 mb-2">No AWS Data Available</h3>
                  <p className="text-gray-600 mb-4">Configure your AWS Role ARN above and click "Refresh Data" to view your cost breakdown.</p>
                </div>
              )}
            </Card>
          </TabsContent>
                  ...
                  <tbody>
                    {mockResources
                      ...
                      <tr key={idx} className="border-b hover:bg-gray-50 transition-colors">
                        ...
                        <td className="py-3 px-4 font-bold text-orange-700">${resource.cost.toFixed(2)}</td>
                      </tr>
                    ))}
                  </tbody>
                </table>
